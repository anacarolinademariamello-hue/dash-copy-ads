...
<div class="page-header">
  <div class="page-header-title">Gerador de Copy &middot; Meta Ads</div>
  <div class="page-header-sub">Preencha o briefing e clique em Gerar &mdash; as 5 copies aparecem na barra lateral</div>
</div>
"""
...
<div style="background:linear-gradient(135deg,#003f7c,#1a5a9a);border-radius:10px;padding:12px 14px;margin-bottom:10px;">
  ...
  <div style="margin-top:8px;display:flex;gap:6px;flex-wrap:wrap;">
    ...
    <span style="background:rgba(255,255,255,.08);color:rgba(255,255,255,.7);font-size:.7rem;padding:2px 8px;border-radius:12px;">{fd['tipo_criativo']}</span>
  </div>
</div>
"""
